...
public class UsersService {
    ...
    public static Users selectById(int id, DatabaseConnection database) {
        ...
        PreparedStatement statement = database.newStatement("SELECT  , y, z FROM Users WHERE id = ?");
        ...
        try {
            if (statement != null) {
                ...
                if (results != null) {
                    result = new Users(results.getInt("x"), results.getString("y"), results.getString("z"));
                }
            }
        } catch (SQLException resultsException) {
